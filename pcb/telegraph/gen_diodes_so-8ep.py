...
# based on https://www.mouser.com/datasheet/2/115/AP3513E-271581.pdf
# added solder mask parameter
# added optional indicator circle
# added ground plane

PARTNAME = "Diodes-SO-8EP"
...
Z = 6.900 # distance across outer edges of pads
G = 3.900 # distance across inner edges of pads

X = (Z+G)/2. # distance between pad centers
C = 1.270 # footprint pad spacing
w = 0.650 # footprint pad width
h = (Z-G)/2. # footprint pad length

H = 6.0 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.405 # physical pad width
L1 = (H-3.9)/2 # physical pad length

D1 = 3.9 # package width
E1 = 4.9 # package height
